...
echo -e "Found $(oc logs ${ETCD[0]} -c etcd|grep heartbeat|wc -l) heartbeat messages"
echo -e "Found $(oc logs ${ETCD[0]} -c etcd|grep 'database space exceeded'|wc -l) database space exceeded messages"
echo -e "Found $(oc logs ${ETCD[0]} -c etcd|grep 'leader changed'|wc -l) leader changed messages"
echo -e ""
...
echo -e "Found $(oc logs ${ETCD[1]} -c etcd|grep heartbeat|wc -l) heartbeat messages"
echo -e "Found $(oc logs ${ETCD[1]} -c etcd|grep 'database space exceeded'|wc -l) database space exceeded messages"
echo -e "Found $(oc logs ${ETCD[1]} -c etcd|grep 'leader changed'|wc -l) leader changed messages"
echo -e ""
...
echo -e ""
echo -e "LOGS \nstart on $(oc logs ${ETCD[2]} -c etcd|head -60|tail -1|cut -d ':' -f3|cut -c 2-14)"
echo -e "ends on $(oc logs ${ETCD[2]} -c etcd|tail -1|cut -d ':' -f3|cut -c 2-14)"
echo -e ""
...
echo -e "Found $(oc logs ${ETCD[2]} -c etcd|grep heartbeat|wc -l) heartbeat messages"
echo -e "Found $(oc logs ${ETCD[2]} -c etcd|grep 'database space exceeded'|wc -l) database space exceeded messages"
echo -e "Found $(oc logs ${ETCD[2]} -c etcd|grep 'leader changed'|wc -l) leader changed messages"
echo -e ""
echo -e "COMPACTION: \n$(oc logs ${ETCD[2]} -c etcd|grep compaction|tail -8|cut -d ':' -f10|cut -c 2-12)"
echo -e ""
